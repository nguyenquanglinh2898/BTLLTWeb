...
<html>
    ...
    <body>
        ...
        <div class="delete-instrument container">
            <form method="POST">
                <div class="guitar">
                    ID: <input type="text" name="id" value="${g.id}" disabled>                        <br><br>
                    Name: <input type="text" name="name" value="${g.name}" disabled>                           <br><br>
                    Type: <input type="text" name="type" value="${g.type}" disabled>                           <br><br>
